...
[![Skills](https://img.shields.io/badge/skills-47-yellow?style=flat-square)](#-스킬-인덱스)
...
| **unity-sentis** 🆕 | Unity 런타임에서 ONNX ML 모델 직접 실행 (Unity 6.3+) — NPC 행동, 애니메이션 예측, 온디바이스 AI 추론 | `unity-sentis` |
| **npc-ml-agents** 🆕 | Unity ML-Agents로 적응형 NPC 에이전트 훈련 (PPO/SAC/모방학습) — Sentis 배포용 ONNX 모델 추출 | `npc-ml-agents` |
