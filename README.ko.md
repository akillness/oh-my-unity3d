...
| **npc-ml-agents** | Unity ML-Agents로 PPO/SAC, 모방학습 기반 NPC를 학습하고 ONNX로 내보낸 모델을 Sentis 배포에 연결 | `npc-ml-agents` |
| **unity-sentis** | Unity Sentis와 ONNX를 활용해 NPC 행동, 애니메이션 예측, 분석, 적응형 플레이 시스템에 온디바이스 AI 추론 적용 | `unity-sentis` |
