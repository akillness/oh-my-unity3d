...
| **npc-ml-agents** | Train adaptive Unity NPC agents with PPO/SAC and imitation learning, export ONNX models for Sentis deployment, and implement RL behavior systems | `npc-ml-agents` |
| **unity-sentis** | Run on-device Unity ML inference with Sentis and ONNX for NPC behavior, animation prediction, analytics, and adaptive gameplay systems | `unity-sentis` |
